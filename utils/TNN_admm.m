...
segn = 7;
segm = 2;
orig = orig((segn-1)*seg+1:segn*seg,(segm-1)*seg+1:segm*seg,1:8);
mask = mask((segn-1)*seg+1:segn*seg,(segm-1)*seg+1:segm*seg,:);
meas = meas((segn-1)*seg+1:segn*seg,(segm-1)*seg+1:segm*seg,1);
